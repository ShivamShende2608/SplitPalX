  ...
  const expenseDatas = [
    {
      ...
      splits: [
        ...
        { userId: user2._id, amount: 625.0, paid: true },
      ],
      createdBy: user1._id,
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 225.0, paid: true },
  ...
  const weekendTripExpenses = [
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 3166.67, paid: false },
        { userId: user2._id, amount: 3166.67, paid: true },
        { userId: user3._id, amount: 3166.66, paid: true },
      ],
    ...
    },
    {
      ...
      splits: [
        ...
        { userId: user2._id, amount: 816.92, paid: false },
        { userId: user3._id, amount: 816.91, paid: true },
      ],
      groupId: groups[0]._id, // Weekend Trip Group
      createdBy: user2._id,
    },
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 1500.0, paid: true },
  ...
  const officeExpenses = [
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user2._id, amount: 425.0, paid: false },
        { userId: user3._id, amount: 425.0, paid: true },
      ],
  ...
  const projectExpenses = [
    {
      ...
      splitType: "equal",
      splits: [
        { userId: user1._id, amount: 400.0, paid: true },
    ...
    },
    {
      ...
      splits: [
        ...
        { userId: user2._id, amount: 1200.0, paid: true },
