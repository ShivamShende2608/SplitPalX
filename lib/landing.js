...
export const TESTIMONIALS = [
  {
  quote:
    "With SplitPalX, I run the numbers better than I cook. No more arguments over who paid for what.",
  name: "Walter White",
  image: "/testimonials/walter.jpg",
  role: "Chemistry Teacher turned Entrepreneur",
},
{
  quote:
    "Yo, SplitPalX is tight! Now I don’t gotta guess who owes me for the pizza... or the RV repairs.",
  name: "Jesse Pinkman",
  image: "/testimonials/jesse.webp",
  role: "Streetwise Business Partner",
},
{
  quote:
    "Need to settle debts? Call Saul! Or better, use SplitPalX. It's faster, safer, and 100% legal.",
  name: "Saul Goodman",
